...
-- Telescope
key("n", "<leader>fg", "<Cmd>Telescope live_grep<CR>", { noremap = true, silent = true, desc = "Find Word - Telescope" })
key("n", "<leader>ff", "<Cmd>Telescope find_files<CR>", { noremap = true, silent = true, desc = "Find File - Telescope" })
key("n", "<leader>fb", "<Cmd>Telescope buffers<CR>", { noremap = true, silent = true, desc = "Find Buffer - Telescope" })
key("n", "<leader>cs", "<Cmd>Telescope colorscheme<CR>", { noremap = true, silent = true, desc = "Change Colorscheme - Telescope" })
...
-- Lspsaga commands
key("n", "gh", "<cmd>Lspsaga lsp_finder<CR>", {noremap = true, silent = true, desc = "Find the Symbol Definition implement Reference" })
key({"n", "v"}, "<leader>ca", "<cmd>Lspsaga code_action<CR>", { noremap = true, silent = true, desc = "Show Code Actions" })
...
key("n", "<leader>cd", "<cmd>Lspsaga show_line_diagnostics<CR>", { noremap = true, silent = true, desc = "Show Line Diagnostics" })
...
key("n","<leader>o", "<cmd>LSoutlineToggle<CR>", { noremap = true, silent = true, desc = "Toggle Outline Diagnostics" })
